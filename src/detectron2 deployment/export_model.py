...
# Modified by Callum Morrison, 2020
import argparse
import os
import onnx
import torch
...
def export_tracing(torch_model, inputs):
    ...
    class WrapModel(nn.Module):
        ...
        def forward(self, image):
            inputs = [{"image": image}]
            outputs = self.torch_model.inference(
                inputs, do_postprocess=False)[0]
...
if __name__ == "__main__":
    ...
    register_coco_instances(f"{dataset}_test", {
    }, f"/home/appuser/detectron2_repo/datasets/{dataset}/test/instances_plants_test2021.json", f"/home/appuser/detectron2_repo/datasets/{dataset}/test/plants_test2021")
    register_coco_instances(f"{dataset}_val", {
    }, f"/home/appuser/detectron2_repo/datasets/{dataset}/validate/instances_plants_validate2021.json", f"/home/appuser/detectron2_repo/datasets/{dataset}/validate/plants_validate2021")
